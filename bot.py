...
async def start(client: Client, message: Message):
    async def worker(client: Client, message: Message):
        ...
        #await bot.edit_message_text(ID_DB,message_id=12,text=dumps(xd,indent=4))
...
#**‼️Solo espere a que se encienda**''')
        ...
        if out_message.startswith('/start'):
            ...
            button2 = InlineKeyboardButton("👨🏻‍💻 Propietario",url = "https://t.me/MM90CS24")
            button3 = InlineKeyboardButton("🗣 Soporte",url = "https://t.me/+hazcikk4f2hlYzBh")
            buttons = [[button1,button2,button3]]
            reply_markup = InlineKeyboardMarkup(buttons)
            await bot.send_photo(username,'start.jpg',reply_markup=reply_markup,caption='''Hola 👋🏻  Bienvenido a Chocomilk, 
...
Para empezar envié un archivo o enlaces para procesar''')
            return
